...
<details>
  <summary>Client</summary>
    <ul>
    <li><a href="https://github.com/SFarida/hello-react-front-end">Hello React Front-end</a></li>
  </ul>
</details>
<details>
...
Feel free to check the [issues page](https://github.com/SFarida/hello-rails-back-end/issues).
